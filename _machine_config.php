...
GlobalConfig::$CONNECTION_SETTING->DBName = "Consultorio";
...
/** the root url of the application with trailing slash, for example http://localhost/consultorio/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'consultorio/';
